...
function CheckoutStatus() {
  ...
  return resCode === "00" ? (
    <div className="min-h-[60vh] bg-gray-100 flex flex-col justify-center items-center px-4">
    ...
    <div className="min-h-[60vh] bg-gray-100 flex flex-col justify-center items-center px-4">
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="px-4 py-6 sm:px-8 sm:py-10 text-center">
          <p className="text-gray-700 text-lg">
            Chúng tôi không thể xử lý đơn hàng của bạn tại thời điểm này. Vui
            lòng thử lại sau hoặc liên hệ với bộ phận hỗ trợ khách hàng của
            chúng tôi.
          </p>
